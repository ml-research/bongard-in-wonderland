...
def main(model):
    ...
    prompt_path = f"prompts/count_in_shape/count_in_shape.txt"
    prompt = open(prompt_path, "r").read()

    top_path = "data/bongard-problems-high-res/p0029"
    ...
    for seed in [1, 2, 3]:
        ...
        for i in range(len(image_paths)):
            ...
            response_path = f"results/count/{model}/pe/{seed}/response_img_{i}.txt"
