...
def main(model):
    ...
    prompt_path = f"prompts/triangle/triangle_pe.txt"
    ...
    top_path = "data/bongard-problems-high-res/p0036"
    ...
    for seed in [1, 2, 3]:
        ...
        for i in range(len(image_paths)):
            ...
            response_path = (
                f"results/triangle_over_circle/{model}/pe/{seed}/response_img_{i}.txt"
            )
...
if __name__ == "__main__":
    for model in ["gpt-4o", "claude", "gemini", "llava_1.6"]:
        main(model)
